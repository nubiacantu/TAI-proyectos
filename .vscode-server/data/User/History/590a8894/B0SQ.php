          ...
          <div class="min-w-0 flex-auto ">
            ...
            <div id="accordion-collapse" data-accordion="collapse">
              <h2 id="accordion-collapse-heading-1">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-pink-500 border border-b-0 border-red-200 rounded-t-xl focus:ring-4 focus:ring-red-200 dark:focus:ring-red-800 dark:border-red-700 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-800" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
