        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/alumnos" class="text-white hover:bg-pink-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Alumnos</a>
              <a href="/curriculum" class="text-white hover:bg-pink-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Curriculum</a>
            </div>
          </div>
        </div>
