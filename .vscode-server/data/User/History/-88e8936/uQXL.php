        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="bg-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" >Inicio</a>
              <a href="/alumnos" class="bg-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Alumnos</a>
              <a href="/curriculum" class="bg-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Curriculum</a>
            </div>
          </div>
        </div>
